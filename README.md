...
The deployed site has no framework dependency or build step.
...
The visual-resume format was inspired by [Paul Ivanov](https://pirsquared.org/blog/visual-resume.html).
